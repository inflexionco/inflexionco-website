      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-[4/3] bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl flex items-center justify-center text-8xl">
              💼
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transition-all duration-300 active:scale-95 md:shadow-sm md:hover:shadow-md md:hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900">Document Collaboration</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transition-all duration-300 active:scale-95 md:shadow-sm md:hover:shadow-md md:hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900">Project Boards</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transition-all duration-300 active:scale-95 md:shadow-sm md:hover:shadow-md md:hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900">Video Conferencing</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 transition-all duration-300 active:scale-95 md:shadow-sm md:hover:shadow-md md:hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900">Workflow Automation</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl border border-green-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-green-600 rounded-full mr-3"></div>
                  <span className="text-gray-700">tRPC</span>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl border border-purple-100">
              <h3 className="text-xl font-bold mb-4 text-gray-900">Real-time</h3>
              <div className="space-y-3">
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-purple-600 rounded-full mr-3"></div>
                  <span className="text-gray-700">WebRTC</span>
                </div>
              </div>
            </div>
          </div>
