      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="col-span-2">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Inflexion Co.</h3>
            <p className="text-sm text-gray-600 mb-4 max-w-xs">
              Building innovative digital products and experiences that transform ideas into reality.
            </p>
            <div className="flex space-x-3">
              <a href="#" className="w-9 h-9 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors">
