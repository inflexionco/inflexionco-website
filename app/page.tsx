    ...
    <div className="bg-gradient-to-br from-[#E8F8F5] via-[#F5FBF8] to-[#FEF9F0]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/projects"
                  className="group inline-flex items-center justify-center bg-black text-white px-8 py-4 rounded-full font-semibold hover:bg-gray-800 transition-all shadow-md hover:shadow-lg"
                >
                  See our work
                ...
                <Link
                  href="/support"
                  className="inline-flex items-center justify-center bg-white border-2 border-gray-200 text-black px-8 py-4 rounded-full font-semibold hover:border-black transition-all shadow-sm hover:shadow-md"
                >
                  Get in touch
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl hover:shadow-lg transition-all border border-gray-100">
              ...
              <h3 className="text-lg font-bold mb-2">Web Applications</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Modern, responsive web apps with optimal performance.
              </p>
            </div>
            ...
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl hover:shadow-lg transition-all border border-gray-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Beautiful, intuitive interfaces for seamless user experience.
              </p>
            </div>
            ...
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl hover:shadow-lg transition-all border border-gray-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Robust, scalable APIs for secure data management.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">We guide you every step of the journey</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Step 1 */}
            <div className="text-center">
              <div className="w-14 h-14 bg-gray-100 text-black rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                01
              </div>
      ...
      <section className="py-24 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/projects"
            className="inline-flex items-center bg-white text-black px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all shadow-lg"
          >
            Explore our work
