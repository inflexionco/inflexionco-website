...
import { ArrowLeft, Github, ExternalLink, Star, Users, Download } from 'lucide-react';
...
const project = getProjectById('glidebrowser')!;
...
const isAndroidApp = project.type === 'android';

export default function GlideBrowserPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
              ...
              <div className="flex flex-wrap gap-3">
                {project.links?.github && (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`inline-flex items-center gap-2 px-6 py-3 rounded-lg transition-colors font-semibold ${colors.button}`}
                  >
      ...
      {/* Screenshots Section */}
      {isAndroidApp && project.screenshots.length > 1 && (
        <section className="py-16 bg-gray-50 dark:bg-gray-800 transition-colors">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex gap-6 overflow-x-auto pb-4 pt-4 justify-center items-center min-h-[600px]">
