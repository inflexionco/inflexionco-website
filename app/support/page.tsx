        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              {/* Email Card */}
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 hover:shadow-lg transition-all border border-gray-100">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 hover:shadow-lg transition-all border border-gray-100">
                ...
                <h3 className="text-base font-bold text-gray-900 mb-2">Quick Response</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 hover:shadow-md transition-shadow border border-gray-100">
              <h3 className="text-base font-bold text-gray-900 mb-2">How quickly will I receive a response?</h3>
              <p className="text-sm text-gray-700">We typically respond within 24-48 hours during business days. Urgent matters are prioritized.</p>
            </div>
            <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 hover:shadow-md transition-shadow border border-gray-100">
              <h3 className="text-base font-bold text-gray-900 mb-2">What information should I include in my message?</h3>
              <p className="text-sm text-gray-700">Please include the app/project name, a clear description of your issue or feedback, and any relevant screenshots or error messages.</p>
            </div>
            <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 hover:shadow-md transition-shadow border border-gray-100">
              <h3 className="text-base font-bold text-gray-900 mb-2">Do you offer technical support for all projects?</h3>
              <p className="text-sm text-gray-700">Yes! We provide ongoing support for all our applications. For custom projects, support terms are defined in the project agreement.</p>
            </div>
          </div>
        </div>
      </section>
