          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6 transition-colors">
                Fundly transforms how teams work together by providing a unified platform for communication, project management, and document collaboration. Built for distributed teams who need to stay connected.
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed transition-colors">
                With real-time updates and intelligent workflow automation, Fundly ensures everyone stays on the same page while reducing the overhead of coordination.
              </p>
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-purple-600 to-indigo-600 text-white transition-colors">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-10 leading-relaxed">
            Fundly is actively under development. Contact us to learn about early access opportunities.
          </p>
